...
class RankingIndiScreenDetail extends StatefulWidget {
  const RankingIndiScreenDetail({Key? key}) : super(key: key);

  @override
  State<RankingIndiScreenDetail> createState() => _RankingIndiScreenDetailState();
}

class _RankingIndiScreenDetailState extends State<RankingIndiScreenDetail> {
