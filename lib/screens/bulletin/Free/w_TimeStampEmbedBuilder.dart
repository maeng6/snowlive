...
class TimeStampEmbedBuilderWidget extends EmbedBuilder {
  ...
  Widget build(
    ...
    final TimeStampController timeStampController = Get.find<TimeStampController>();
    final timestamp = node.value.data;
    final formattedDate = timeStampController.yyyymmddFormat(timestamp);
    final agoTime = timeStampController.getAgoTime(timestamp);
