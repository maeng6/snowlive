...
import '../../../controller/vm_bulletinReplyController.dart';
                                                                    ...
                                                                    try {
                                                                      await FirebaseFirestore
                                                                          ...
                                                                          .collection(
                                                                              'bulletinRoom')
                                                                          .doc(
                                                                              '${_userModelController.uid}#${_bulletinRoomModelController.bulletinRoomCount}')
                                                                          .delete();
                                                                      try {
                          ...
                          child: Container(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  if (_bulletinRoomModelController
                                  ...
                                  if (_bulletinRoomModelController
                                    ...
                                    ExtendedImage.network(
                                      '${_bulletinRoomModelController.profileImageUrl}',
                                      shape: BoxShape.circle,
                                      borderRadius: BorderRadius.circular(20),
                                      width: 32,
                                      height: 32,
                                        ...
                                        Row(
                                          children: [
                                            Row(
                                              children: [
                                                Text(
                                                  '${_bulletinRoomModelController.displayName}',
                                ...
                                Row(
                                  children: [
                                    Container(
                                      ...
                                      child: Text(
                                        '${_bulletinRoomModelController.category}',
                                        style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 12,
