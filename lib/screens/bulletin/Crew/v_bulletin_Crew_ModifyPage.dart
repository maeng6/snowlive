...
class _Bulletin_Crew_ModifyPageState extends State<Bulletin_Crew_ModifyPage> {
  ...
  ListTile buildResortListTile(int index) {
    return ListTile(
      ...
      onTap: () async {
        ...
        SelectedLocation!.value = bulletinCrewResortList[index];
  ...
  ListTile buildCategoryListTile(int index) {
    return ListTile(
      ...
      onTap: () async {
        ...
        SelectedCategory!.value = bulletinCrewCategoryList[index];
  ...
  void initState() {
    ...
    _imageUrls!.addAll(_bulletinCrewModelController.itemImagesUrls!);
    SelectedCategory = _bulletinCrewModelController.category!.obs;
                ...
                TextButton(
                    onPressed: () async{
                      ...
                      if(isValid){
                        ...
                        await _imageController.setNewMultiImage_bulletinCrew(_imageFiles, _bulletinCrewModelController.bulletinCrewCount);
                        (isModifiedImageSelected==true)
                            ...
                            timeStamp: _bulletinCrewModelController.timeStamp,
                            snsUrl: _snsUrlTextEditingController.text,
                            viewerUid: _bulletinCrewModelController.viewerUid
                        )
                            : await _bulletinCrewModelController.updateBulletinCrew(
                            displayName: _userModelController.displayName,
                            uid: _userModelController.uid,
