...
class Bulletin_Lost_Upload extends StatefulWidget {
  const Bulletin_Lost_Upload({Key? key}) : super(key: key);

  @override
  State<Bulletin_Lost_Upload> createState() => _Bulletin_Lost_UploadState();
}

class _Bulletin_Lost_UploadState extends State<Bulletin_Lost_Upload> {
  ...
  ListTile buildCategoryListTile(int index) {
    return ListTile(
      ...
      onTap: () async {
        ...
        SelectedCategory = bulletinLostCategoryList[index];
                    ...
                    onPressed: () async{
                      ...
                      if(_tileSelected["구분"]!.isEmpty){
                        ...
                        if(isValid){
                          ...
                          await _userModelController.bulletinLostCountUpdate(_userModelController.uid);
                          await _imageController.setNewMultiImage_bulletinLost(_imageFiles, _userModelController.bulletinLostCount);
                          await _bulletinLostModelController.uploadBulletinLost(
                              ...
                              bulletinLostCount: _userModelController.bulletinLostCount,
                          ...
                          Get.off(() => Bulletin_Lost_List_Detail());
                        }
