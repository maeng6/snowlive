...
class BulletinLostImageScreen extends StatefulWidget {
  BulletinLostImageScreen({Key? key}) : super(key: key);

  @override
  State<BulletinLostImageScreen> createState() =>
      _BulletinLostImageScreenState();
}

class _BulletinLostImageScreenState extends State<BulletinLostImageScreen> {
