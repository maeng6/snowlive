                ...
                : GestureDetector(
                  child: Padding(
                    ...
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Text('취소', style: TextStyle(fontSize: 16, color: Colors.white),),
                      ],
                    ),
                  ),
                  onTap: () {
                    ...
                    GestureDetector(
                      child: Padding(
                        ...
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                          children: [
                            Text('완료', style: TextStyle(fontSize: 16, color: Colors.white),),
                          ],
                        ),
                      ),
                      onTap: () async{
                              ...
                              children: [
                                ...
                                (edit == true)
                                  ...
                                  child: Container(
                                    ...
                                    : Text('${friendDocs[0]['stateMsg']}', style: TextStyle(fontSize: 14, color: Color(0xFF949494)),),
                              ],
                            ),
                          ),//프사 + 닉네임 + 상메
                              ...
                              children: [
                                Column(
                                  children: [
                                    IconButton(
                                        ...
                                        iconSize: 32,
                                        icon: Image.asset('assets/imgs/icons/icon_edit_nickname.png')
                                    ),
                                    Text('프로필 수정', style: TextStyle(fontSize: 13, color: Color(0xFF111111)),)
                                  ],
                                ),
                                SizedBox(
                                  width: 40,
                                ...
                                Column(
                                  children: [
                                    ...
                                    Text('이미지 수정', style: TextStyle(fontSize: 13, color: Color(0xFF111111)),)
                                  ],
                                ),
                                SizedBox(
                                  width: 40,
