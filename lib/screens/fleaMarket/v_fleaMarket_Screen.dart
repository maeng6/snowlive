                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Container(
                                          padding: EdgeInsets.only(top: 1, left: 3,right: 3,bottom: 4),
                                          child: Text(
                                            'NEW',
                                            style: TextStyle(color: Color(0xFF3D6FED),fontSize: 10),
                                          ),
                                          decoration: BoxDecoration(
                                            borderRadius: BorderRadius.circular(10),
                                            border: Border.all(color: Color(0xFF3D6FED), width: 1),
                                          ),
                                        ),
                                        SizedBox(
                                          width: 6,
                                    ...
                                    Row(
                                      children: [
                                        Container(
                                          ...
                                          child: Text(
                                            'HOT',
                                            style: TextStyle(color: Color(0xFFF9A441),fontSize: 10),
                                          ),
                                          decoration: BoxDecoration(
                                            borderRadius: BorderRadius.circular(10),
                                            border: Border.all(color: Color(0xFFF9A441), width: 1),
                                          ),
                                        ),
                                        SizedBox(
                                          width: 6,
                                    ...
                                    Row(
                                      children: [
                                        Container(
                                          ...
                                          child: Text(
                                            'EVENT',
                                            style: TextStyle(color: Color(0xFF17AD4A),fontSize: 10),
                                          ),
                                          decoration: BoxDecoration(
                                            borderRadius: BorderRadius.circular(10),
                                            border: Border.all(color: Color(0xFF17AD4A), width: 1),
                                          ),
                                        ),
                                        SizedBox(
                                          width: 6,
