...
class FleaChatroom_Buy extends StatefulWidget {
  const FleaChatroom_Buy({Key? key}) : super(key: key);

  @override
  State<FleaChatroom_Buy> createState() =>
      _FleaChatroom_BuyState();
}

class _FleaChatroom_BuyState
    extends State<FleaChatroom_Buy> {
