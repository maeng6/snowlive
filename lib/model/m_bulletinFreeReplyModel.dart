...
class BulletinFreeReplyModel {
  BulletinFreeReplyModel(
      {this.displayName,
        this.uid,
  ...
  BulletinFreeReplyModel.fromJson(dynamic json, this.reference) {
    reply = json['reply'];
  ...
  BulletinFreeReplyModel.fromSnapShot(DocumentSnapshot<Map<String, dynamic>> snapshot)
      : this.fromJson(snapshot.data(), snapshot.reference);

  Future<BulletinFreeReplyModel> getReplyModel(String uid, String replyLocationUid,replyLocationUidCount ,commentCount , replyResortNickname) async {
    ...
    BulletinFreeReplyModel commentModel = await BulletinFreeReplyModel.fromSnapShot(documentSnapshot);
    return commentModel;
  }
