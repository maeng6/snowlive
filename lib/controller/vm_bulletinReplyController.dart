...
import '../model/m_bulletinReplyModel.dart';

class BulletinRoomReplyModelController extends GetxController {
  RxString? _uid = ''.obs;
  ...
  Future<void> sendReply(
    ...
    await BulletinRoomReplyModel().uploadReply(
      reply: reply,
  ...
  String getAgoTime(timestamp){
    String time = BulletinRoomReplyModel().getAgo(timestamp);
    return time;
  }
