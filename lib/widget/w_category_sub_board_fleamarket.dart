...
class _CategorySubBoardFleamarketWidgetState extends State<CategorySubBoardFleamarketWidget> {
  List<bool?> _isSelected = List<bool?>.filled(5, false);
  String? category_sub_board;
        ...
        children: [
                    ...
                    ListTile(
                      ...
                      onTap: () {
                        setState(() {
                          ...
                          category_sub_board = category_sub_board_list[index];
                        });
                      },
                    ),
          ...
          Container(
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.pop(context, category_sub_board);
...
List<String?> category_sub_board_list = [
  '데크',
  '바인딩',
  '부츠',
  '의류',
