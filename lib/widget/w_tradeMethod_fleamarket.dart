...
class TradeMethodFleamarketWidget extends StatefulWidget {

  @override
  _TradeMethodFleamarketWidgetState createState() => _TradeMethodFleamarketWidgetState();
}

class _TradeMethodFleamarketWidgetState extends State<TradeMethodFleamarketWidget> {
        ...
        children: [
          ...
          Container(
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.pop(context, tradeMethod);
