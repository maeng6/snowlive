...
class FavoriteResortWidget extends StatefulWidget {

  @override
  _FavoriteResortWidgetState createState() => _FavoriteResortWidgetState();
}

class _FavoriteResortWidgetState extends State<FavoriteResortWidget> {
