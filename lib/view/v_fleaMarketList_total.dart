...
import 'package:com.snowlive/viewmodel/vm_fleamarket.dart';
...
class FleaMarketListView_total extends StatefulWidget {
  const FleaMarketListView_total({Key? key}) : super(key: key);

  @override
  State<FleaMarketListView_total> createState() => _FleaMarketListView_totalState();
}

class _FleaMarketListView_totalState extends State<FleaMarketListView_total> {
                        ...
                        child: Stack(
                          children: [
                            ElevatedButton(
                                                ...
                                                child: Wrap(
                                                  children: [
                                                    ListTile(
                                                      ...
                                                      title: Center(
                                                        child: Text(
                                                          '${FleamarketCategory_main.total.korean}',
                                                      ...
                                                      onTap: () async {
                                                        Navigator.pop(context);
                                                        _fleamarketViewModel.changeCategory_main_total('${FleamarketCategory_main.total.korean}');
                                                    ...
                                                    ListTile(
                                                      ...
                                                      title: Center(
                                                        child: Text(
                                                          '${FleamarketCategory_main.deck.korean}',
                                                          style: SDSTextStyle.bold.copyWith(
                                                              fontSize: 15,
                                                              color: SDSColor.gray900
                                                          ),
                                                      ...
                                                      onTap: () async {
                                                        Navigator.pop(context);
                                                        _fleamarketViewModel.changeCategory_main_total('${FleamarketCategory_main.deck.korean}');
                                                        await _fleamarketViewModel.fetchFleamarketData_total(
                                                            userId: _userViewModel.user.user_id,
                                                            categoryMain: _fleamarketViewModel.selectedCategory_main_total,
                                                            categorySub: _fleamarketViewModel.selectedCategory_sub_total
                                                    ...
                                                    ListTile(
                                                      ...
                                                      title: Center(
                                                        child: Text(
                                                          '${FleamarketCategory_main.binding.korean}',
                                                          style: SDSTextStyle.bold.copyWith(
                                                              fontSize: 15,
                                                              color: SDSColor.gray900
                                                          ),
                                                      ...
                                                      onTap: () async {
                                                        Navigator.pop(context);
                                                        _fleamarketViewModel.changeCategory_main_total('${FleamarketCategory_main.binding.korean}');
                                                        await _fleamarketViewModel.fetchFleamarketData_total(
                                                            userId: _userViewModel.user.user_id,
                                                            categoryMain: _fleamarketViewModel.selectedCategory_main_total,
                                                            categorySub: _fleamarketViewModel.selectedCategory_sub_total
                                                    ...
                                                    ListTile(
                                                      ...
                                                      title: Center(
                                                        child: Text(
                                                          '${FleamarketCategory_main.boots.korean}',
                                                          style: SDSTextStyle.bold.copyWith(
                                                              fontSize: 15,
                                                              color: SDSColor.gray900
                                                          ),
                                                      ...
                                                      onTap: () async {
                                                        Navigator.pop(context);
                                                        _fleamarketViewModel.changeCategory_main_total('${FleamarketCategory_main.boots.korean}');
                                                        await _fleamarketViewModel.fetchFleamarketData_total(
                                                            userId: _userViewModel.user.user_id,
                                                            categoryMain: _fleamarketViewModel.selectedCategory_main_total,
                                                            categorySub: _fleamarketViewModel.selectedCategory_sub_total
                                                    ...
                                                    ListTile(
                                                      ...
                                                      title: Center(
                                                        child: Text(
                                                          '${FleamarketCategory_main.cloth.korean}',
                                                          style: SDSTextStyle.bold.copyWith(
                                                              fontSize: 15,
                                                              color: SDSColor.gray900
                                                          ),
                                                      ...
                                                      onTap: () async {
                                                        Navigator.pop(context);
                                                        _fleamarketViewModel.changeCategory_main_total('${FleamarketCategory_main.cloth.korean}');
                                                        await _fleamarketViewModel.fetchFleamarketData_total(
                                                            userId: _userViewModel.user.user_id,
                                                            categoryMain: _fleamarketViewModel.selectedCategory_main_total,
                                                            categorySub: _fleamarketViewModel.selectedCategory_sub_total
                                                    ...
                                                    ListTile(
                                                      ...
                                                      title: Center(
                                                        child: Text(
                                                          '${FleamarketCategory_main.plate.korean}',
                                                          style: SDSTextStyle.bold.copyWith(
                                                              fontSize: 15,
                                                              color: SDSColor.gray900
                                                          ),
                                                      ...
                                                      onTap: () async {
                                                        Navigator.pop(context);
                                                        _fleamarketViewModel.changeCategory_main_total('${FleamarketCategory_main.plate.korean}');
                                                        await _fleamarketViewModel.fetchFleamarketData_total(
                                                            userId: _userViewModel.user.user_id,
                                                            categoryMain: _fleamarketViewModel.selectedCategory_main_total,
                                                            categorySub: _fleamarketViewModel.selectedCategory_sub_total
                                                    ...
                                                    ListTile(
                                                      ...
                                                      title: Center(
                                                        child: Text(
                                                          '${FleamarketCategory_main.etc.korean}',
                                                          style: SDSTextStyle.bold.copyWith(
                                                              fontSize: 15,
                                                              color: SDSColor.gray900
                                                          ),
                                                      ...
                                                      onTap: () async {
                                                        Navigator.pop(context);
                                                        _fleamarketViewModel.changeCategory_main_total('${FleamarketCategory_main.etc.korean}');
                                                        await _fleamarketViewModel.fetchFleamarketData_total(
                                                            userId: _userViewModel.user.user_id,
                                                            categoryMain: _fleamarketViewModel.selectedCategory_main_total,
                                                            categorySub: _fleamarketViewModel.selectedCategory_sub_total
                                ...
                                child:
                                     Text('${_fleamarketViewModel.selectedCategory_main_total}',
                                    style: TextStyle(
                                        fontSize: 14,
                                        fontWeight: FontWeight.bold,
