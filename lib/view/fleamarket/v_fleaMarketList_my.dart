                    ...
                    child: (_fleamarketListViewModel.fleamarketListMy.length == 0)
                      ...
                      child: Scrollbar(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount: _fleamarketListViewModel.fleamarketListMy.length + 1,
                          physics: AlwaysScrollableScrollPhysics(),
                          itemBuilder: (context, index) {
                            if(_fleamarketListViewModel.isLoadingList_my==true) {
                              return Column(
                                children: [
                                  Container(
                                    height: 110,
                            ...
                            if(index == _fleamarketListViewModel.fleamarketListMy.length){
                              return Obx(() => _fleamarketListViewModel.isLoadingNextList_my == true// 여기서 Obx 사용
                                  ? Center(
                                child: Padding(
