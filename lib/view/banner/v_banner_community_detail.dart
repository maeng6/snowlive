...
class Banner_community_detail extends StatefulWidget {
  @override
  _Banner_community_detailState createState() => _Banner_community_detailState();
}
...
class _Banner_community_detailState extends State<Banner_community_detail> {
  ...
  void initState() {
    super.initState();
    _resortHomeViewModel.getBanner('community_detail');
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder(
      stream: _resortHomeViewModel.bannerStream_community_detail.value,
                  ...
                  onTap: () async {
                    ...
                    try {
                      FirebaseAnalytics.instance.logEvent(
                        name: 'tap_banner_community_detail',
