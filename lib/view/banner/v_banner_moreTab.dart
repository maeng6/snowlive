...
class Banner_moreTab extends StatefulWidget {
  @override
  _Banner_moreTabState createState() => _Banner_moreTabState();
}
...
class _Banner_moreTabState extends State<Banner_moreTab> {
  ...
  void initState() {
    super.initState();
    _resortHomeViewModel.getBanner('moreTab');
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      var data = _resortHomeViewModel.bannerData_moreTab.value;
