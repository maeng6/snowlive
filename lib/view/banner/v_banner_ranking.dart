...
class Banner_ranking extends StatefulWidget {
  @override
  _Banner_rankingState createState() => _Banner_rankingState();
}

class _Banner_rankingState extends State<Banner_ranking> {
  ...
  void initState() {
    super.initState();
    _resortHomeViewModel.getBanner('ranking');
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      var data = _resortHomeViewModel.bannerData_ranking.value;
