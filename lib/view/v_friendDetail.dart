          ...
          child: Container(
            ...
            child: SafeArea(
              child: Container(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  //TODO: 프사
                                  (_friendDetailViewModel.friendDetailModel.profileImageUrlUser.isNotEmpty)
                                      ? GestureDetector(
                                    onTap: () {
                                      Get.toNamed(AppRoutes.userProfileIamge,arguments:_friendDetailViewModel.friendDetailModel.profileImageUrlUser);
                                    },
                                    child: Container(
                                        width: 110,
                                        height: 110,
                                        ...
                                        child: ExtendedImage.network(
                                          _friendDetailViewModel.friendDetailModel.profileImageUrlUser,
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            crossAxisAlignment: CrossAxisAlignment.center,
                                            children: [
                                              Text('${_friendDetailViewModel.friendDetailModel.displayName}',
                                                style: TextStyle(
                                                    fontSize: 22,
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            '${_friendDetailViewModel.friendDetailModel.favoriteResort} · ${_friendDetailViewModel.friendDetailModel.crewName}',
                                            style: TextStyle(
                                                fontSize: 14,
                                        ...
                                        //TODO: 상태메세지
                                        (_friendDetailViewModel.friendDetailModel.stateMsg)
                                            ? Container(
                                          child: Text('${_friendDetailViewModel.friendDetailModel.stateMsg}', style: TextStyle(
                                              fontSize: 14,
                                        ...
                                        //TODO: 친구추가 버튼
                                        if(_userViewModel.user.user_id == _friendDetailViewModel.friendDetailModel.userId)
                                          Container(), //프디페 = 내 프디페
                                        if(_userViewModel.user.user_id != _friendDetailViewModel.friendDetailModel.userId &&
                                            !_friendDetailViewModel.friendDetailModel.areWeFriend)
                                          ElevatedButton(
                                            onPressed: () async{
                                              Get.dialog(
                                                  AlertDialog(
                                                          ...
                                                          TextButton(
                                                              onPressed: () async {
                                                                await _friendDetailViewModel.sendFriendRequest({
                                                                  ...
                                                                  "friend_user_id": _friendDetailViewModel.friendDetailModel.userId    //필수 - 신청받는사람
                                                                });
                                                              },
                                                              child: Text('보내기',
                                                                style: TextStyle(
                                              ...
                                              GestureDetector(
                                                onTap:() async{
                                                  await _friendDetailViewModel.checkFriendRelationship({
                                                    ...
                                                    "friend_user_id": _friendDetailViewModel.friendDetailModel.userId
                                                  });
                                                ...
                                                child: Obx(()=>Container(
                                                  child: (!_friendDetailViewModel.friendDetailModel.bestFriend)
                                                      ? Text('색깔 별 ')
                                                      : Text('색깔 없는 별'),
                                                )),
                                              ),
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            Container(
                                                              child: Column(
                                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                                children: _friendDetailViewModel.friendDetailModel.seasonRankingInfo.countInfo.map((data) {
                                                          ...
                                                          children: [
                                                            ...
                                                            Container(
                                                              child: Row(
                                                                ...
                                                                children: _friendDetailViewModel.friendDetailModel.seasonRankingInfo.timeInfo.entries.map((entry) {
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child: Text(
                                                                    (_friendDetailViewModel.selectedDailyIndex != -1)
                                                                        ? '${_friendDetailViewModel.friendDetailModel.calendarInfo.dailyInfo.length}'
                                                                        : '0',
                                                                    style: SDSTextStyle.extraBold.copyWith(
                                                                        color: SDSColor.gray900,
                                                                        fontSize: 24
                                                                ...
                                                                ? Container(
                                                                    child: Column(
                                                                      crossAxisAlignment: CrossAxisAlignment.start,
                                                                      children: _friendDetailViewModel.friendDetailModel.calendarInfo[_friendDetailViewModel.selectedDailyIndex].dailyInfo.map((data) {
                                                                        String slopeName = data.slope;
                                                                        int passCount = data.count;
                                                                        double barWidthRatio = data.ratio;
                                                                        return Padding(
                                                              ...
                                                              children: [
                                                                ...
                                                                ? Container(
                                                                  child: Row(
                                                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                                    crossAxisAlignment: CrossAxisAlignment.end,
                                                                    children: _friendDetailViewModel.friendDetailModel.calendarInfo[_friendDetailViewModel.selectedDailyIndex].timeInfo.entries.map((entry) {
                                                                      String slotName = entry.key;
                                                                      int passCount = entry.value;
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              Padding(
                                                  ...
                                                  child: Column(
                                                    children: [
                                                      (_friendDetailViewModel.friendDetailModel.guestBook.length >0)
                                                      ? Column(
                                                        children: [
                                                          ListView.builder(
                                                            ...
                                                            itemCount: _friendDetailViewModel.friendDetailModel.guestBook.length,
                                                            itemBuilder: (context, index) {
                                                              final document = _friendDetailViewModel.friendDetailModel.guestBook[index];
                                                              Timestamp timestamp = _friendDetailViewModel.friendDetailModel.guestBook[index].get('update_time');
                                                              ...
                                                              return Column(
                                                                children: [
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      if (document['author_info']['profile_image_url_user'] != "")
                                                                        GestureDetector(
                                                                          onTap: () async{
                                                                            await _friendDetailViewModel.fetchFriendDetailInfo(userId: _userViewModel.user.user_id, friendUserId: document['author_info']['user_id'], season: _friendDetailViewModel.seasonDate);
                                                                          ...
                                                                          child: Container(
                                                                            ...
                                                                            child: ExtendedImage.network(
                                                                              document['author_info']['profile_image_url_user'],
                                                                              cache: true,
                                                                              shape: BoxShape.circle,
                                                                              borderRadius:
                                                                      ...
                                                                      Row(
                                                                        children: [
                                                                          Text(
                                                                            document['author_info']['display_name'],
                                                                            style: TextStyle(
                                                                                fontSize: 13,
                                                                                color: Color(0xFF949494)
                                                                            ),),
                                                                          ...
                                                                          onTap: () =>
                                                                              showModalBottomSheet(
                                                                                  ...
                                                                                  builder: (context) {
                                                                                    return SafeArea(
                                                                                      child: Container(
                                                                                        height: (_friendDetailViewModel.friendDetailModel.user.userId == _userViewModel.user.user_id
                                                                                            || document['author_info']['user_id'] == _userViewModel.user.user_id)
                                                                                            ? 200 : 150,
                                                                                        child: Padding(
                                                                                          padding: const EdgeInsets.symmetric(horizontal: 20.0, vertical: 14),
                                                                                          child: Column(
                                                                                            children: [
                                                                                              if(_friendDetailViewModel.friendDetailModel.user.userId == _userViewModel.user.user_id
                                                                                                  || document['author_info']['user_id'] == _userViewModel.user.user_id)
                                                                                                GestureDetector(
                                                                                                  child: ListTile(
                                                                                                                    ...
                                                                                                                    Row(
                                                                                                                      ...
                                                                                                                      children: [
                                                                                                                        ...
                                                                                                                        Expanded(
                                                                                                                          child: ElevatedButton(
                                                                                                                            onPressed: () async {
                                                                                                                              await _friendDetailViewModel.deleteFriendsTalk(userId: _userViewModel.user.user_id, friendsTalkId: document['friends_talk_id']);
                                                                                                                              print('삭제 완료');
                                                                                                                              Navigator.pop(context);
                                                                                                                            },
                                                                                                                            child: Text('확인',
                                                                                                                      ...
                                                                                                                      await _friendDetailViewModel.reportFriendsTalk({
                                                                                                                        {
                                                                                                                          ...
                                                                                                                          "friends_talk_id": document['friends_talk_id']    //필수 - 신고할 친구톡id
                                                                                                                        }
                                                                                                                      });
                                                                                                                      Navigator.pop(context);
                                                                                                                      Navigator.pop(context);
                                                                                                                ...
                                                                                                                TextButton(
                                                                                                                    onPressed: () async{
                                                                                                                      await _friendDetailViewModel.blockUser({
                                                                                                                        ...
                                                                                                                        "block_user_id" : document['author_info']['user_id']      //필수 - 내가 차단할 사람
                                                                                                                      });
                                                                                                                      Navigator.pop(context);
                                                                                                                      Navigator.pop(context);
                                                                                                                    },
                ...
                (_friendDetailViewModel.mainTabName == FriendDetailViewModel.mainTabNameListConst[1]
                    && _userViewModel.user.user_id != _friendDetailViewModel.friendDetailModel.userId)
                        ? Positioned(
                      left: 0,
                      right: 0,
                      bottom: 0,
                            ...
                            decoration: InputDecoration(
                                ...
                                suffixIcon: IconButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    await _friendDetailViewModel.fetchFriendsTalkList(userId: _userViewModel.user.user_id, friendUserId: _friendDetailViewModel.friendDetailModel.userId);
                                      FocusScope.of(context).unfocus();
                                      _friendDetailViewModel.textEditingController.clear();
                                  },
                                  icon: (_friendDetailViewModel.textEditingController.text.trim().isEmpty)
                                      ? Image.asset(
