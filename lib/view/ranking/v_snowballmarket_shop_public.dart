...
class SnowballMarketPublicShopView extends StatefulWidget {
  @override
  State<SnowballMarketPublicShopView> createState() =>
      _SnowballMarketPublicShopViewState();
}

class _SnowballMarketPublicShopViewState
    extends State<SnowballMarketPublicShopView> {
  SnowballShopViewModel _snowballShopViewModel =
  Get.find<SnowballShopViewModel>();
              ...
              children: [
                Expanded(
                  child: RefreshIndicator(
                    ...
                    // ⬇⬇⬇ 여기부터: 스크롤 최하단 도달 시 다음 url로 fetch ⬇⬇⬇
                    child: NotificationListener<ScrollNotification>(
                      onNotification: (ScrollNotification notification) {
                        // 스크롤이 아래 끝에 거의 도달했을 때 처리
                        if (notification.metrics.pixels >=
                            notification.metrics.maxScrollExtent - 50) {
                          final nextUrl =
                              _snowballShopViewModel.nextPageUrlShop;

                          if (nextUrl != null &&
                              nextUrl.isNotEmpty &&
                              !_snowballShopViewModel
                                  .isMoreLoading.value) {
                            _snowballShopViewModel.fetchSnowballShop(
                              isTierOnly: false,
                              isForMission: false,
                      ...
                      child: ListView(
                        ...
                        physics:
                        const AlwaysScrollableScrollPhysics(), // pull-to-refresh 항상 가능
                        children: [
                          Column(
                            children: [
                              Padding(
                              ...
                              GridView.builder(
                                ...
                                itemCount: _snowballShopViewModel
                                    .shopItems.length,
                                itemBuilder: (context, index) {
                                  final item = _snowballShopViewModel
                                      .shopItems[index];
                                  return Stack(
                                    children: [
                                      GestureDetector(
                        ...
                        Expanded(
                          child: ElevatedButton(
                            onPressed: () async {
                              ...
                              CustomFullScreenDialog.cancelDialog();
                              Get.toNamed(
                                  AppRoutes.snowballMarketBuyRecord);
                            },
                            style: ElevatedButton.styleFrom(
                              elevation: 0,
                              backgroundColor: const Color(0xFF3D83ED),
