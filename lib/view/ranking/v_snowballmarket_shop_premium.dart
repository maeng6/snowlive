...
class SnowballMarketPremiumShopView extends StatefulWidget {
  @override
  State<SnowballMarketPremiumShopView> createState() => _SnowballMarketPremiumShopViewState();
}

class _SnowballMarketPremiumShopViewState extends State<SnowballMarketPremiumShopView> {
                                            ...
                                            children: [
                                              ...
                                              if (item.itemCount != 0)
                                                Text(
                                                  ...
                                                  style: SDSTextStyle.regular.copyWith(fontSize: 12, color: Color(0xFF3D83ED)),
                                                ),
                                              if (item.itemCount == 0)
                                                Text(
                                                  '품절',
