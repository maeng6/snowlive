...
class SnowballMarketPublicShopView extends StatefulWidget {
  @override
  State<SnowballMarketPublicShopView> createState() => _SnowballMarketPublicShopViewState();
}

class _SnowballMarketPublicShopViewState extends State<SnowballMarketPublicShopView> {
                        ...
                        child: RefreshIndicator(
                          ...
                          child: NotificationListener<ScrollNotification>(
                            ...
                            child: ListView(
                              ...
                              physics: const AlwaysScrollableScrollPhysics(), // pull-to-refresh 항상 가능
                              children: [
                                Column(
                                  children: [
                                    Padding(
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        (item.landingUrl != null && item.landingUrl != '')
                                                                            ...
                                                                            : Container(),
                                                                        (item.landingUrl != null && item.landingUrl != '') ? const SizedBox(width: 10) : Container(),
                                                                        Expanded(
                                                                          child: ElevatedButton(
                                                                            onPressed: () async {
