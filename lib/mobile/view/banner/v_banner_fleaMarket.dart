...
class Banner_fleaMarket extends StatefulWidget {
  @override
  _Banner_fleaMarketState createState() => _Banner_fleaMarketState();
}

class _Banner_fleaMarketState extends State<Banner_fleaMarket> {
  ...
  void initState() {
    super.initState();
    _resortHomeViewModel.getBanner('fleaMarket');
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      var data = _resortHomeViewModel.bannerData_fleaMarket.value;
