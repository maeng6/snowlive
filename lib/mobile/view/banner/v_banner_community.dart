...
class Banner_community extends StatefulWidget {
  @override
  _Banner_communityState createState() => _Banner_communityState();
}

class _Banner_communityState extends State<Banner_community> {
  ...
  void initState() {
    super.initState();
    _resortHomeViewModel.getBanner('community');
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      var data = _resortHomeViewModel.bannerData_community.value;
          ...
          if (bannerWidgets.isNotEmpty) {
            ...
            return Padding(
              padding: bannerWidgets.length > 0
                  ? EdgeInsets.only(right: 12, left: 12, bottom: 16)
